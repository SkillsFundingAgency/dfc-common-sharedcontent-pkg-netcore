...
public static class InitialiseExtensions
{
    public static void AddSharedContentRedisInterface(this IServiceCollection services, string redisConnectionString)
    {
        ...
        services.AddScoped<ISharedContentRedisInterfaceStrategy<TriageToolFilter>, TriageToolAllQueryStrategy>();
        ...
        services.AddScoped<ISharedContentRedisInterfaceStrategy<JobProfileCategory>, DysacJobProfileCategoriesQueryStrategy>();
        ...
        services.AddScoped<ISharedContentRedisInterfaceStrategy<PersonalityTrait>, TraitsQueryStrategy>();

        services.AddScoped<ISharedContentRedisInterfaceStrategy<JobProfileDysacResponse>, JobProfileOverviewQueryStrategy>();
