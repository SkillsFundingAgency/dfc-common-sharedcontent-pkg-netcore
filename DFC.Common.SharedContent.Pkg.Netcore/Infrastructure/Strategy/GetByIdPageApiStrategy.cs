...
{
    public class GetByIdPageApiStrategy : ISharedContentRedisInterfaceStrategyWithRedisExpiry<GetByPageApiResponse>
    {
        ...
        public async Task<GetByPageApiResponse> ExecuteQueryAsync(string key, string filter, double expire = 4)
        {
